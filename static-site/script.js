...
function createVehicleCard(vehicle) {
    ...
    return `
        <div class="vehicle-card">
            <a href="/api/site/detail.html?id=${vehicle.id}" class="card-image">
            ...
            <div class="card-content">
                <a href="/api/site/detail.html?id=${vehicle.id}" class="card-title">${vehicle.marque} ${vehicle.modele}</a>
                ...
                <div class="card-actions">
                    <a href="/api/site/detail.html?id=${vehicle.id}" class="btn btn-outline">Voir détails</a>
    ...
    if (!vehicle) {
        document.getElementById('vehicleDetail').innerHTML = `
            <div class="no-results" style="grid-column: 1 / -1;">
                ...
                <a href="/api/site/index.html" class="btn btn-primary">
